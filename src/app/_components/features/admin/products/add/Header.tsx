...
export default function AddHeader({ title, onCancel, onSaveDraft, onSubmit }: AddHeaderProps) {
  return (
    <div className="sticky top-0 z-30 bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
      <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between">
        <h1 className="text-base md:text-lg font-semibold">{title ?? "Tambah Produk"}</h1>
