...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Cancel
      ...
      className={cn(
        "inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-muted text-foreground hover:bg-muted/80 h-9 px-4 py-2",
        className
      )}
      {...props}
    />
